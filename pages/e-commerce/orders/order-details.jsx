    ...
    return (
        <div className="bg-white rounded-lg p-[30px] flex flex-col gap-y-[30px]">
            <Card className="px-[30px]">
                ...
                <span className="mb-[6px] block font-[400]">Order no: #23456</span>
                <span className="block font-[400]">Customer: Henry</span>
                <div className="flex items-center mt-4">
                    ...
                    <img src="/assets/left-arrow.svg" className="ml-auto mr-7" alt="" />
                    ...
                    <TitleCard title="Shipping activity" subtitle="Edit">
                        ...
                        <div className="flex flex-col gap-y-6">
                            ...
                            <div className="flex items-center">
                                ...
                                <div className="ml-3">
                                    <p className=" font-semibold text-black">Out for delivery</p>
                                    <span>2:18pm</span>
                                </div>
                            </div>
                            <div className="flex items-center">
                                ...
                                <div className="ml-3">
                                    <p className=" font-semibold text-black">Package arrived at the final delivery station</p>
                                    <span>2:18pm</span>
                                </div>
                            </div>
                        </div>
                    ...
                    <TitleCard title="Customer" className="px-[20px]">
                        <div className="flex flex-col gap-y-[30px]">
                            <div className="flex items-center">
                                ...
                                <p className="ml-3 font-semibold text-black">Harvey</p>
                            ...
                            <div className="flex items-center">
                                ...
                                <p className="ml-3 font-semibold text-black">Orders</p>
                                <img className="ml-auto" src="/assets/right-arrow.svg" alt="" />
                            </div>
                            <div className="flex items-center justify-between">
                                <div>
                                    <p className="font-semibold mb-1 text-black">Contact info</p>
                            ...
                            <div className="flex items-center justify-between">
                                <div>
                                    <p className="font-semibold mb-1 text-black">Shipping Address </p>
                            ...
                            <div className="flex items-center justify-between">
                                <div>
                                    <p className="font-semibold mb-1 text-black">Billing Address</p>
                                    <span>Berlin, Germany</span>
                                </div>
                                <span className="text-primary font-semibold">Edit</span>
                            </div>
