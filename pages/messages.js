...
const messages = () => {
  return (
    <div className="p-[30px] rounded-lg flex gap-x-10 bg-[#262626] ">
      <div className="w-[300px]">
        ...
        <div className='relative mt-7'>
          ...
          <input type="text" className='py-[14px] w-full pl-12 pr-6 rounded-lg bg-surface-background' placeholder='Search chat' />
        </div>
      ...
      <div className="flex-1 rounded-lg shadow-shadow1 bg-[#403F3F]">
        ...
        <div className="p-[30px] flex flex-col gap-y-[25px] relative max-h-[70vh] overflow-auto">
          {[0, 1, 1, 1,2,2,2].map((message, index) => (
