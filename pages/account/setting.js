...
const setting = () => {
    ...
    return (
        <div className='flex flex-col md:flex-row gap-x-10 h-full p-4 sm:p-[30px] bg-white'>
            <div className="sm:w-[262px]">
                ...
                <div className='mt-[30px] sm:mt-0'>
                    <TitleCard title="Basic Information">
                        <div className="flex gap-4 items-center mb-[25px] ">
                            ...
                            <div>
                                <p className="font-bold text-black">Profile Photo</p>
                        ...
                        <FilledButton className="mt-[30px] w-full sm:w-fit">Update</FilledButton>

                    </TitleCard>
                    <div className='mt-[30px]'></div>
                    <TitleCard title="Notifications" >
                        <div className='sm:flex w-[100%]'>
                            <div className='sm:pr-[30px] mr-[25px] min-w-[50%] border-r-[1px] '>
                    ...
                    <TitleCard title="Password & Security" >
                        <div className='flex gap-y-[25px] gap-x-[50px] flex-wrap'>
                            ...
                            <div className='w-full xl:w-[45%] relative'>
                                ...
                                <input type="text" className='py-[14px] w-full pl-12 border border-surface-border pr-6 rounded-lg bg-surface-accent' placeholder='Confirm New Password' />
                            </div>
                        </div>
                        <FilledButton className="mt-[30px] w-full sm:w-fit">Update</FilledButton>
                    </TitleCard>
