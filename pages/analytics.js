...
const analytics = () => {
  return (
    <div className="rounded-lg grid grid-cols-7 gap-x-[30px] pb-10">
      <div className="col-span-4">
        ...
        <Card className="mt-[30px] bg-white">
        ...
        <Card className="mt-[30px] bg-white py-5 px-5">
            ...
            {[0, 1, 2].map(entry => (
              <div className="grid grid-cols-2 gap-x-20">
                <div className="flex justify-between items-center">
                  ...
                  <span className="ml-auto font-light">Completed</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="font-light">$140</span>
                  <span className="font-light">+15.65%</span>
      ...
      <div className="col-span-3 flex flex-col gap-y-[30px]">
        ...
        <Card className="py-5 bg-white px-5"> 
            <h2 className="mb-[17px]">Statistics</h2>
              <div className="border border-surface-border rounded-lg py-3 px-4 mb-5">
                  <div>
                    <h2 className="mb-[10px] text-lg">Weekly Target</h2>
                    <span>25% achieved</span>
                  </div>
              </div>
              <div className="border border-surface-border rounded-lg py-3 px-4">
                  <div>
                    <h2 className="mb-[10px] text-lg">Weekly Target</h2>
                    <span>25% achieved</span>
                  </div>
