...
const addUser = () => {
  return (
    <div>
        <h2 className="text-black mb-[10px] w-[100%]">Basic Information</h2>
        <div className="flex gap-4 items-center mt-[40px] mb-[30px]">
        ...
        <div className="flex flex-wrap justify-between w-full gap-[15px] pr-[20px]">
        ...
        <div className="flex justify-end mt-[25px] mr-[20px]">
