...
const Overview = () => {
  return (
    <div>
      ...
      <div className='rounded-lg p-[20px] shadow-shadow2 bg-white mt-6 mb-8'>
        <div className=' flex justify-between mb-5'>
          <div className='relative '>
            ...
            <input type="text" className='py-[14px] w-full pl-12 border border-surface-border pr-12 rounded-lg bg-surface-background' placeholder='Search for user...' />
          </div>
