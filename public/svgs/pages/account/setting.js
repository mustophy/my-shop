...
const setting = () => {
    ...
    return (
        <div className='flex flex-col md:flex-row gap-x-10 h-full p-4 sm:p-[30px] bg-surface-gray'>
                ...
                <div className=''>
                    ...
                    <TitleCard title="Notifications" >
                        <div className='sm:flex w-[100%]'>
                            <div className='sm:pr-[30px] sm:mr-[25px] min-w-[50%] sm:border-r-[1px] '>
                                ...
                                <div className='flex gap-4 mt-5'>
                                    ...
                                    <div>
                                        <h2 className='font-bold text-[15px] mb-1'>News and Updates</h2>
                                ...
                                <div className='flex gap-4 mt-5'>
                                    <div className='mt-[5px]'><SwitchBtn /></div>
                                    <div>
                                        <h2 className='font-bold text-[15px] mb-1'>Tips and tutorials</h2>
                                ...
                                <div className='flex gap-4 mt-5'>
                                    <div className='mt-[5px]'><SwitchBtn /></div>
                                    <div>
                                        <h2 className='font-bold text-[15px] mb-1'>User research</h2>
                                ...
                                <div className='flex gap-4 mt-5'>
                                    <div className='mt-[5px]'><SwitchBtn /></div>
                                    <div>
                                        <h2 className='font-bold text-[15px] mb-1'>Comments</h2>
                                ...
                                <div className='flex gap-4 mt-5'>
                                    <div className='mt-[5px]'><SwitchBtn /></div>
                                    <div>
                                        <h2 className='font-bold text-[15px]'>Reminders</h2>
                    ...
                    <TitleCard title="Password & Security" >
                        <div className='flex gap-y-[25px] gap-x-[50px] flex-wrap'>
                            <div className='w-full xl:w-[45%] relative '>
                                ...
                                <input type="text" className='py-[14px] w-full pl-12 pr-6 rounded-lg bg-surface-background text-white' placeholder='Enter Current Password' />
                            </div>
                            <div className='w-full xl:w-[45%] relative'>
                                <div className='absolute top-6 text-[20px] left-4'>
                                    <img src="/assets/setting/key.svg" alt="" />
                                </div>
                                <input type="text" className='py-[14px] w-full pl-12 pr-6 rounded-lg bg-surface-background text-white' placeholder='Enter New Password' />
                            </div>
                            <div className='w-full xl:w-[45%] relative'>
                                <div className='absolute top-6 text-[20px] left-4'>
                                    <img src="/assets/setting/key.svg" alt="" />
                                ...
                                <input type="text" className='py-[14px] w-full pl-12 pr-6 rounded-lg bg-surface-background text-white' placeholder='Confirm New Password' />
                            </div>
                        </div>
                        <div className="flex justify-end mt-[35px] mb-[10px] mr-[25px]">
                            <FilledButton>Update</FilledButton>
                    ...
                    <TitleCard title="Delete your account" >
                        ...
                        <div className='flex flex-col gap-[15px] md:flex-row justify-start md:justify-end mt-[35px] mb-[10px] sm:mr-[25px]'>
                            <OutlineButton className='px-[35px]'>Learn more</OutlineButton>
                            <FilledButton className=''>Delete</FilledButton>
                        </div>
                    </TitleCard>
                </div>
            </div>
